...
def total_balance_sheet_true(stress_MT=0,stress_interest_rates=0, adapt=True):
	return balancesheetPE.total_balance_sheet_true(stress_MT,stress_interest_rates, adapt)

def total_balance_sheet_predicted(stress_MT=0,stress_interest_rates=0, adapt=True):
	return  balancesheetPE.total_balance_sheet_predicted(stress_MT,stress_interest_rates, adapt)
